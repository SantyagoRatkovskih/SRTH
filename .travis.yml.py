...
install:
  ...
  - echo "TODO"
  - gem install dpl --pre
  - dpl releases --token $GITHUB_TOKEN --file "bin/SRTH-1.0-armeabi-v7a-debug.apk" --tag_name "v.1.0"
  ...
  - echo "TODO"
  - gem install dpl --pre
  - dpl releases --token $GITHUB_TOKEN --file "bin/SRTH-1.0-arm64-v8a-debug.apk" --tag_name "v.1.0"
script:
  - echo "OK"
